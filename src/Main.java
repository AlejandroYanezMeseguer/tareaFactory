...
public class Main {
    ...
    mistransportes=FactoryTransport.getProducto(FactoryTransport.camion);
        System.out.println("Coste del envio: " + mistransportes.costeTotal(12345) + "€");
        System.out.println("Tipo de embalaje: " + mistransportes.tipoEmbalaje(3, 60, 20, 6));
        /**
        ...
        System.out.println("Coste del envio: " + mistransportes.costeTotal(34567) + "€");
        System.out.println("Tipo de embalaje: " + mistransportes.tipoEmbalaje(4, 20, 1, 19));
